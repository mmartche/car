...
switch ($_POST[action]) {
	...
	case 'clone':
		...
		break;
		case 'model':
			$sqlAdd = "INSERT into `model` (`idManufacturer`, `name`, `idSegment`, `description`, `active`) VALUES ('".$_POST[manufacturerId]."','".$_POST[modelName]."','".$_POST[idSegment]."','".$_POST[description]."','s') ";

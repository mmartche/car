			...
			<div class="chamadaH2">
				<a href="#">
					<img class="foto" src="http://carsale.uol.com.br/novosite/images/home/Ford-Focus_Sedan_h3.jpg" alt="..." />
					<h3>Lançamento</h3>
					<h4>Novo Ford Focus Sedan quer clientes do Honda Civic</h4>
				</a>
			</div>
			<div class="chamadaH2">
				<a href="#">
					<img class="foto" src="http://carsale.uol.com.br/novosite/images/home/Focus%20Test%20Drive%20Mendoza_h3.jpg" alt="..." />
					<h3>Dois-volumes</h3>
					<h4>Enquanto o hatchback mira GM Cruze e VW Golf</h4>
				</a>
			</div>

<!-- USE OS TAMANHOS PARA CHAMADAS DIFERENTES: 
		P = 
		M = 
		G = 
			<div class="chamadaH1">

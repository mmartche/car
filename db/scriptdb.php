...
$listaFull = '"jpg",12390,"Audi-S1-2.jpg",1,"redator","publish",0,"Audi-S1-2.jpg",0,0,0,"1392343599"|"jpg",12390,"Audi-S1-13.jpg",2,"redator","publish",0,"Audi-S1-13.jpg",0,0,0,"1392343599"|"jpg",12390,"Audi-S1-19.jpg",3,"redator","publish",0,"Audi-S1-19.jpg",0,0,0,"1392343599"|"jpg",12390,"Audi-S1-22.jpg",4,"redator","publish",0,"Audi-S1-22.jpg",0,0,0,"1392343599"|"jpg",12390,"Audi-S1-23.jpg",5,"redator","publish",0,"Audi-S1-23.jpg",0,0,0,"1392343599"';
$arrayImgs = explode("|", $listaFull);


for ($i=0; $i < count($arrayImgs); $i++) { 
	$sqlImg = "insert into `wp_wppa_photos` (`ext`, `album`, `name`, `p_order`, `owner`, `status`, `rating_count`, `filename`, `modified`, `views`, `page_id`,`timestamp`) values (".$arrayImgs[$i].");";
	echo $sqlImg;
	// $qImg = mysql_query($sqlImg) or die ("fudeu no => ".$i." com o array =+ ".$arrayImgs[$i]);
	// $id_inserted = mysql_insert_id();
	$id_inserted = "teste.jpg";
	$arrayValues = explode(",", $arrayImgs[$i]);
	$imgTemp = "http://carsale.uol.com.br/asp/img/Album/".str_replace('"', '', $arrayValues[2]);
	$imgDest = "/noticias-br/wp-content/uploads/wppa/".$id_inserted;
	// echo "<p>".$$sqlImg."</p><p>".$imgTemp."</p><p>".$imgDest."</p>";
	// fopen($imgTemp, "r");

	...
	<!--nav class="navbar navbar-default navbar-fixed-top" role="navigation"-->
		<ul class="nav nav-pills">
			...
			<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="menuEditorial" title="">Editorial<span class="caret"></span></a>
			</li>
			<li class="dropdown">
			...
			<li class="subMenuLi">
				<ul class="subMenu dropdown-menu" id="submenuClassificados">
					<li><a href="http://carsale.uol.com.br/classificado/explorador" title="">Explorador</a></li>
					<li><a href="http://carsale.uol.com.br/classificado/mega-oferta" title="">Mega Oferta</a></li>
				</ul>
				<ul class="subMenu dropdown-menu" id="submenuEditorial">
					<li><a href="http://carsale.uol.com.br/editorial/noticia/listagem/" title="">Notícias</a></li>
					<li><a href="http://carsale.uol.com.br/editorial/segredos/listagem/" title="">Segredos</a></li>
					<li><a href="http://carsale.uol.com.br/editorial/avaliacao/listagem/" title="">Testes</a></li>
					<li><a href="http://carsale.uol.com.br/editorial/lancamentos/listagem/" title="">Lançamentos</a></li>
